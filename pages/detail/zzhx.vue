				...
				<transition name="collapse">
					<view class="account-info-section" v-if="getOptions(PAYMENT_ACCOUNT_INFORMATION)">
						<view class="account-card">
							...
							<!-- <view class="account-info-block" style="margin-top: 18.116rpx;" v-if="itemDatas.receivingBankName || itemDatas.receivingBankAccountName || itemDatas.receivingBankAccountNumber"> -->
							<view class="account-info-block" style="margin-top: 18.116rpx;" v-if="isShowClaimCategory">
								<view class="account-info-row">
